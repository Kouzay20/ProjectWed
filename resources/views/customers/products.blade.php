                ...
                <div class="d-inline-flex align-items-center">
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <button class="dropdown-item" href="{{url('customers/login')}}" type="button">Sign in</button>
                            <button class="dropdown-item" href="{{url('customers/customerregister')}}" type="button">Sign up</button>
                        </div>
                    </div>
        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-9 col-md-8">
                ...
                <div class="row pb-3">
                        ...
                        <div class="product-item bg-light mb-4">
                            <div class="product-img position-relative overflow-hidden">
                                ...
                                <div class="product-action">
                                    <a class="btn btn-outline-dark btn-square" href="{{url('customers/productsdetail')}}"><i class="fa fa-shopping-cart"></i></a>
                            ...
                            <div class="text-center py-4">
                                ...
                                <div class="d-flex align-items-center justify-content-center mt-2">
                                    <h5>{{$p->productprice}}$</h5><h6 class="text-muted ml-2"><del>$123.00</del></h6>
                                </div>
                    ...
                    {{-- <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                        <div class="product-item bg-light mb-4">
                            <a class="h6 text-decoration-none text-truncate" href="" style="text-align:center">{{$p->productname}}</a>
                            <div> <img src="../pro_img/{{$p->productimage}}" class ="image_2"></div>
                            <h5>Price: {{$p->productprice}}$</h5>
