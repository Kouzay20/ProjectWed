                ...
                <div class="d-inline-flex align-items-center">
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item" href="<?php echo e(url('customers/register')); ?>">Sign up</a>
                            <?php endif; ?>
                        </div>
                    </div>
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="<?php echo e(url('customers/index')); ?>" class="nav-item nav-link active">Home</a>
...
</html><?php /**PATH C:\xampp\htdocs\GCS210834project\resources\views/customers/index.blade.php ENDPATH**/ ?>