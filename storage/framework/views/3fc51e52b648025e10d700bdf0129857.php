...
<body>
    ...
    <div class="container-fluid">
        <div class="row bg-secondary py-1 px-xl-5">
            <div class="col-lg-6 d-none d-lg-block">
                <div class="d-inline-flex align-items-center h-100">
                    <a class="text-body mr-3" href="<?php echo e(url('customers/about')); ?>">About</a>
                    <a class="text-body mr-3" href="<?php echo e(url('customers/contact')); ?>">Contact</a>
                    <a class="text-body mr-3" href="<?php echo e(url('customers/help')); ?>">Help</a>
                    <a class="text-body mr-3" href="<?php echo e(url('customers/faq')); ?>">FAQs</a>
                </div>
            </div>
            <div class="col-lg-6 text-center text-lg-right">
                            <?php if(Session::has('customerEmail')): ?>
                            <a href=" #" style="margin-right: 30px;"><?php echo e(Session::get('customerPhoto')); ?> WELCOME TO OUR JEWERRY SHOPS: <?php echo e(Session::get('customerName')); ?></a>
                ...
                <div class="d-inline-flex align-items-center">
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item" href="<?php echo e(url('customers/logout')); ?>">Log out</a>
                            <?php else: ?>
                            <a class="dropdown-item" href="<?php echo e(url('customers/login')); ?>">Sign in</a>
                            <a class="dropdown-item" href="<?php echo e(url('customers/customerregister')); ?>">Sign up</a>
                            <?php endif; ?>
                        </div>
                    </div>
        ...
        <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
            <div class="col-lg-4">
                <a href="<?php echo e(url('admin/adminlogin')); ?>" class="text-decoration-none">
        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    <a href="<?php echo e(url('admin/indexs')); ?>" class="text-decoration-none d-block d-lg-none">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="<?php echo e(url('customers/customerhomepage')); ?>" class="nav-item nav-link active">Home</a>
                            <a href="<?php echo e(url('customers/products')); ?>" class="nav-item nav-link">Shop</a>
            ...
            <div class="col-lg-4">
                <div class="product-offer mb-30" style="height: 250px;">
                    ...
                    <div class="offer-text">
                        ...
                        <a href="<?php echo e(url('customers/products')); ?>" class="btn btn-primary">Shop Now</a>
                    </div>
                </div>
                <div class="product-offer mb-30" style="height: 250px;">
        ...
        <div class="row px-xl-5 pb-3">
                ...
                <a class="text-decoration-none" href="">
                    <div class="cat-item d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                            <img class="img-fluid" src="<?php echo e(asset('pro_img/anhtrungbay1.jpg')); ?>" alt="">
                        </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href="">
                    <div class="cat-item img-zoom d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                            <img class="img-fluid" src="<?php echo e(asset('pro_img/hangtrungbay6.png')); ?>" alt="">
                        </div>
                        <div class="flex-fill pl-3">
                            <h6>Bangles</h6>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href="">
                    <div class="cat-item img-zoom d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                            <img class="img-fluid" src="<?php echo e(asset('pro_img/day chuyen kim cuong.jpg')); ?>" alt="">
                        </div>
                        <div class="flex-fill pl-3">
                            <h6>Necklace</h6>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href="">
                    <div class="cat-item img-zoom d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                            <img class="img-fluid" src="<?php echo e(asset('pro_img/hangtrungbay2.jpg')); ?>" alt="">
                        </div>
                        <div class="flex-fill pl-3">
                            <h6>Eardrop</h6>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href="">
                    <div class="cat-item img-zoom d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                            <img class="img-fluid" src="<?php echo e(asset('pro_img/hangtrungbay5.png')); ?>" alt="">
                        </div>
                        <div class="flex-fill pl-3">
                            <h6>Bracelet</h6>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <div class="product-item bg-light mb-4">
                    <div class="product-img position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="../pro_img/<?php echo e($p->productimage); ?>" alt="">
                    ...
                    <div class="text-center py-4">
                        <a class="h6 text-decoration-none text-truncate" href=""><?php echo e($p->productname); ?></a>
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            <h5><?php echo e($p->productprice); ?>$</h5><h6 class="text-muted ml-2"></h6>
                        </div>
...
</html><?php /**PATH C:\xampp\htdocs\ProjectWebEnd\gcs210834projectTranQuangAnhThuanBetterVersion\resources\views/customers/customerhomepage.blade.php ENDPATH**/ ?>